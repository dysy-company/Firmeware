 ...
 * @brief Library for TI ADS869xExt ADC chip.
 * @version 0.1
 * @date 2023-01-10
 * 
...
//SPI define
#define ADS869xExt_SPIx                             SPI3
//Clocks defines
#define ADS869xExt_SPIx_CLK_ENABLE()                __HAL_RCC_SPI3_CLK_ENABLE()
#define ADS869xExt_DMAx_CLK_ENABLE()                __HAL_RCC_DMA1_CLK_ENABLE()
#define ADS869xExt_SPIx_SCK_GPIO_CLK_ENABLE()       __HAL_RCC_GPIOC_CLK_ENABLE()
#define ADS869xExt_SPIx_MISO_GPIO_CLK_ENABLE()      __HAL_RCC_GPIOB_CLK_ENABLE()
#define ADS869xExt_SPIx_MOSI_GPIO_CLK_ENABLE()      __HAL_RCC_GPIOB_CLK_ENABLE()
#define ADS869xExt_SPIx_CS_GPIO_CLK_ENABLE()        __HAL_RCC_GPIOB_CLK_ENABLE()
#define ADS869xExt_SPIx_CS2_GPIO_CLK_ENABLE()       __HAL_RCC_GPIOB_CLK_ENABLE()
#define ADS869xExt_SPIx_CS3_GPIO_CLK_ENABLE()       __HAL_RCC_GPIOA_CLK_ENABLE()
#define ADS869xExt_SPIx_FORCE_RESET()               __HAL_RCC_SPI3_FORCE_RESET()
#define ADS869xExt_SPIx_RELEASE_RESET()             __HAL_RCC_SPI3_RELEASE_RESET()
//DMA defines
#if BOARD_INDEX == 2
#define ADS869xExt_SPIx_DMA_RX_IRQHandler           DMA1_Stream5_IRQHandler
#define ADS869xExt_SPIx_DMA_RX_IRQn                 DMA1_Stream5_IRQn
#define ADS869xExt_SPIx_DMA_RX_IRQn_PreemptPriority 1
#define ADS869xExt_SPIx_DMA_RX_IRQn_SubPriority     0
#define ADS869xExt_SPIx_RX_DMA_REQUEST              DMA_REQUEST_SPI3_RX
#define ADS869xExt_SPIx_RX_DMA_STREAM               DMA1_Stream5

#define ADS869xExt_SPIx_DMA_TX_IRQHandler           DMA1_Stream4_IRQHandler
#define ADS869xExt_SPIx_DMA_TX_IRQn                 DMA1_Stream4_IRQn
#define ADS869xExt_SPIx_DMA_TX_IRQn_PreemptPriority 1
#define ADS869xExt_SPIx_DMA_TX_IRQn_SubPriority     0
#define ADS869xExt_SPIx_TX_DMA_REQUEST              DMA_REQUEST_SPI3_TX
#define ADS869xExt_SPIx_TX_DMA_STREAM               DMA1_Stream4
#endif
#if BOARD_INDEX == 3
#define ADS869xExt_SPIx_DMA_RX_IRQHandler           DMA1_Stream2_IRQHandler
#define ADS869xExt_SPIx_DMA_RX_IRQn                 DMA1_Stream2_IRQn
#define ADS869xExt_SPIx_DMA_RX_IRQn_PreemptPriority 1
#define ADS869xExt_SPIx_DMA_RX_IRQn_SubPriority     0
#define ADS869xExt_SPIx_RX_DMA_CHANNEL              DMA_CHANNEL_0
#define ADS869xExt_SPIx_RX_DMA_STREAM               DMA1_Stream2

#define ADS869xExt_SPIx_DMA_TX_IRQHandler           DMA1_Stream5_IRQHandler
#define ADS869xExt_SPIx_DMA_TX_IRQn                 DMA1_Stream5_IRQn
#define ADS869xExt_SPIx_DMA_TX_IRQn_PreemptPriority 1
#define ADS869xExt_SPIx_DMA_TX_IRQn_SubPriority     0
#define ADS869xExt_SPIx_TX_DMA_CHANNEL              DMA_CHANNEL_0
#define ADS869xExt_SPIx_TX_DMA_STREAM               DMA1_Stream5
#endif
//SPI IRQ defines
#define ADS869xExt_SPIx_IRQHandler                  SPI3_IRQHandler
#define ADS869xExt_SPIx_IRQn                        SPI3_IRQn
#define ADS869xExt_SPIx_IRQn_PreemptPriority        1
#define ADS869xExt_SPIx_IRQn_SubPriority            0
//PC10     ------> SPI3_SCK
#define ADS869xExt_SPIx_SCK_PIN                     GPIO_PIN_10
#define ADS869xExt_SPIx_SCK_GPIO_PORT               GPIOC
#define ADS869xExt_SPIx_SCK_AF                      GPIO_AF6_SPI3
...
//PB4     ------> SPI3_MISO
#define ADS869xExt_SPIx_MISO_PIN                    GPIO_PIN_4
#define ADS869xExt_SPIx_MISO_GPIO_PORT              GPIOB
#define ADS869xExt_SPIx_MISO_AF                     GPIO_AF6_SPI3
#endif

#if (CONTROLLER_BOARD_TYPE == CONTROLLER_BOARD_TYPE_SERVO_HYDRAULIC_GREEN)
 //PC11     ------> SPI3_MISO
#define ADS869xExt_SPIx_MISO_PIN                    GPIO_PIN_11
#define ADS869xExt_SPIx_MISO_GPIO_PORT              GPIOC
#define ADS869xExt_SPIx_MISO_AF                     GPIO_AF6_SPI3
#endif

#if (CONTROLLER_BOARD_TYPE == CONTROLLER_BOARD_TYPE_SERVO_HYDRAULIC_GREEN)
//PB1     ------> SPI3_NSS
#define ADS869xExt_SPIx_CS_PIN                      GPIO_PIN_8
#define ADS869xExt_SPIx_CS_GPIO_PORT                GPIOB
#define ADS869xExt_SPIx_CS_AF                       GPIO_AF6_SPI3
//PB8     ------> SPI3_NSS2
#define ADS869xExt_SPIx_CS2_PIN                     GPIO_PIN_1
#define ADS869xExt_SPIx_CS2_GPIO_PORT               GPIOB
#define ADS869xExt_SPIx_CS2_AF                      GPIO_AF6_SPI3
#else
//PB1     ------> SPI3_NSS
#define ADS869xExt_SPIx_CS_PIN                      GPIO_PIN_1
#define ADS869xExt_SPIx_CS_GPIO_PORT                GPIOB
#define ADS869xExt_SPIx_CS_AF                       GPIO_AF6_SPI3
//PB8     ------> SPI3_NSS2
#define ADS869xExt_SPIx_CS2_PIN                     GPIO_PIN_8
#define ADS869xExt_SPIx_CS2_GPIO_PORT               GPIOB
#define ADS869xExt_SPIx_CS2_AF                      GPIO_AF6_SPI3

#endif
//PA11    ------> SPI3_NSS3
#define ADS869xExt_SPIx_CS3_PIN                     GPIO_PIN_11
#define ADS869xExt_SPIx_CS3_GPIO_PORT               GPIOA
// #define ADS869xExt_SPIx_CS3_AF                      GPIO_AF6_SPI3
//PB2     ------> SPI3_MOSI
#define ADS869xExt_SPIx_MOSI_PIN                    GPIO_PIN_2
#define ADS869xExt_SPIx_MOSI_GPIO_PORT              GPIOB
#define ADS869xExt_SPIx_MOSI_AF                     GPIO_AF7_SPI3
...
/**
 * @enum ADS869xExtTransferState
 * @brief DMA Channel Transfer State
 * 
 */
enum ADS869xExtTransferState : uint32_t{
	ADS869xExt_DMA_SPI_TRANSFER_WAIT,
	ADS869xExt_DMA_SPI_TRANSFER_IN_PROGRESS,
	ADS869xExt_DMA_SPI_TRANSFER_COMPLETE,
	ADS869xExt_DMA_SPI_TRANSFER_ERROR
};

/**
 * @enum ADS869xExtActiveAlarm
 ...
 */
enum ADS869xExtActiveAlarm{
    ADS869xExt_ACTIVE_ALARM_NOT_INCLUDE                            = 0b00,
    ADS869xExt_ACTIVE_ALARM_INCLUDE_H_FLAG                         = 0b01,
    ADS869xExt_ACTIVE_ALARM_INCLUDE_L_FLAG                         = 0b10,
    ADS869xExt_ACTIVE_ALARM_INCLUDE_BOTH                           = 0b11
};

/**
 * @enum ADS869xExtDataVal
 * @brief Data Value enumeration
 * @details Define output word data. Values ready to write into Data Out Control Register
 */
enum ADS869xExtDataVal{
    ADS869xExt_OUTPUT_VALUE_CONVERSION_DATA                        = 0b000,
    ADS869xExt_OUTPUT_VALUE_ALL_ZEROS                              = 0b100,
    ADS869xExt_OUTPUT_VALUE_ALL_UNITS                              = 0b101,
    ADS869xExt_OUTPUT_VALUE_ALTERNATING_ZEROS_AND_UNITS            = 0b110,
    ADS869xExt_OUTPUT_VALUE_ALTERNATING_ZERO_ZEROS_AND_UNIT_UNITS  = 0b111
};

/**
 * @enum ADS869xExtSPIMode
 * @brief SPI Mode enumeration
 * @details SPI Mode Set or Read to/from ADC SDI_CTL_REG register
 */
enum ADS869xExtSPIMode{
    ADS869xExt_SPI_MODE_CPOL_0_CPHASE_0                            = 0b00,
    ADS869xExt_SPI_MODE_CPOL_0_CPHASE_1                            = 0b01,
    ADS869xExt_SPI_MODE_CPOL_1_CPHASE_0                            = 0b10,
    ADS869xExt_SPI_MODE_CPOL_1_CPHASE_1                            = 0b11
};

/**
 * @enum ADS869xExtSDO1Config
 * @brief SDO1 Config Enumeration
 * @details SDO1_CONFIG Bits in SDO_CTL_REG Register
 */
enum ADS869xExtSDO1Config{
    ADS869xExt_SDO1_CONFIG_TRI_STATE_1BIT_SDO_MODE                 = 0b0000000000,
    ADS869xExt_SDO1_CONFIG_ALARM_1BIT_SDO_MODE                     = 0b0100000000,
    ADS869xExt_SDO1_CONFIG_GPO_1BIT_SDO_MODE                       = 0b1000000000,
    ADS869xExt_SDO1_CONFIG_COMBINED_SDO0_2BIT_MODE                 = 0b1100000000
};

/**
 * @enum ADS869xExtSSyncClk
 ...
 */
enum ADS869xExtSSyncClk{
    ADS869xExt_SSYNC_CLK_EXTERNAL_SCLK                             = 0b00000000,
    ADS869xExt_SSYNC_CLK_INTERNAL_CLOCK                            = 0b01000000
};

/**
 * @enum ADS869xExtSDOMode
 * @brief SDO_MODE enumerator
 * @details These bits control the data output modes of the device.
 */
enum ADS869xExtSDOMode{
    ADS869xExt_SDO_MODE_SAME_AS_SDI                                = 0b00,
    ADS869xExt_SDO_MODE_INVALID_CONFIG                             = 0b10,
    ADS869xExt_SDO_MODE_FOLLOW_ADC_MASTER_CLOCK_OR_SS_PROTOCOL     = 0b11
};

/**
 * @enum ADS869xExtRange
 * @brief Input Range enumeration
 * @details Values ready to write into Input Range Register
 */
enum ADS869xExtRange{
    ADS869xExt_PM_3                                                = 0b0000,   //+-3*Vref
    ADS869xExt_PM_2_5                                              = 0b0001,   //+-2.5*Vref
    ADS869xExt_PM_1_5                                              = 0b0010,   //+-1.5*Vref
    ADS869xExt_PM_1_25                                             = 0b0011,   //+-1.25*Vref
    ADS869xExt_PM_0_625                                            = 0b0100,   //+-0.625*Vref
    ADS869xExt_P_3                                                 = 0b1000,   //+3*Vref
    ADS869xExt_P_2_5                                               = 0b1001,   //+2.5*Vref
    ADS869xExt_P_1_5                                               = 0b1010,   //+1.5*Vref
    ADS869xExt_P_1_25                                              = 0b1011    //+1.25*Vref
};

/**
 * @enum ADS869xExtExternalRef
 * @brief External Reference enumeration
 * @details Define external/intenal refence voltage selection.
 */
enum ADS869xExtExternalRef{
    ADS869xExt_EXTERNAL_REF_DISABLED                               = 0b0000000,
    ADS869xExt_EXTERNAL_REF_ENABLED                                = 0b1000000
};
 ...
 */
enum ADS869xExtCmd : uint32_t{
	ADS869xExt_CMD_NOP                                             = 0b00000000000000000000000000000000,
	ADS869xExt_CMD_CLEAR_HWORD                                     = 0b11000000000000000000000000000000,
	ADS869xExt_CMD_READ_HWORD                                      = 0b11001000000000000000000000000000,
	ADS869xExt_CMD_READ_BYTE                                       = 0b01001000000000000000000000000000,
	ADS869xExt_CMD_WRITE                                           = 0b11010000000000000000000000000000,
	ADS869xExt_CMD_WRITE_MSB                                       = 0b11010010000000000000000000000000,
	ADS869xExt_CMD_WRITE_LSB                                       = 0b11010100000000000000000000000000,
	ADS869xExt_CMD_SET_HWORD                                       = 0b11011000000000000000000000000000
};

/**
 * @typedef @struct ADS869xExtSendDataPacket_t
 * @brief Send packet struct ready to send into ADC;
 * @details Define command, address and data value to write;
 */
typedef struct ADS869xExtSendDataPacket{
    ADS869xExtCmd              cmd;
    uint32_t                address;
    uint16_t                data;
} ADS869xExtSendDataPacket_t;

/**
 * @typedef @struct ADS869xExtOutputDataWord_t
 * @brief Output word data structure from ADC.
 * @details Ready to use (align) output data from ADC.
 */
typedef struct ADS869xExtOutputDataWord{
    ...
    uint8_t     inputRange;
    uint8_t     parityBits;
} ADS869xExtOutputDataWord_t;

/**
 * @enum ADS869xExtRegisterAddress
 * @brief Register addresses enumeration
 * @details Define register addresses. Ready to write into ADC input data word.
 */
enum ADS869xExtRegisterAddress : uint32_t{
	ADS869xExt_DEVICE_ID_REG                               = 0x00000000,
	ADS869xExt_RST_PWRCTL_REG                              = 0x00040000,
	ADS869xExt_SDI_CTL_REG                                 = 0x00080000,
	ADS869xExt_SDO_CTL_REG                                 = 0x000C0000,
	ADS869xExt_DATAOUT_CTL_REG                             = 0x00100000,
	ADS869xExt_RANGE_SEL_REG                               = 0x00140000,
	ADS869xExt_ALARM_REG                                   = 0x00200000,
	ADS869xExt_ALARM_H_TH_REG                              = 0x00240000,
	ADS869xExt_ALARM_L_TH_REG                              = 0x00280000
};

/**
 * @enum ADS869xExtRegisterShift
 * @brief Register offsets enumeration
 * @details Define register addresses offsets. Ready to write into ADC input data word.
 */
enum ADS869xExtRegisterShift : uint32_t{
    ADS869xExt_REG_NULL_BYTE                               = 0x00000000,
    ADS869xExt_REG_FIRST_BYTE                              = 0x00010000,
    ADS869xExt_REG_SECOND_BYTE                             = 0x00020000,
    ADS869xExt_REG_THIRD_BYTE                              = 0x00030000
};

/**
 * @typedef @struct ADS869xExtRegisters_t
 * @brief All ADC registers data structure.
 * @details Define all ADC registers values;
 */
typedef struct ADS869xExtRegisters{
...
} ADS869xExtRegisters_t;

/**
 * @brief Register offsets enumeration
 * @details Define register addresses offsets. Ready to write into ADC input data word.
 */
#define ADS869xExt_DATAOUT_CTL_REG_DEVICE_ADDR_INCL        0x00004000
#define ADS869xExt_DATAOUT_CTL_REG_VDD_ACTIVE_ALARM_INCL   0x00003000
#define ADS869xExt_DATAOUT_CTL_REG_IN_ACTIVE_ALARM_INCL    0x00000C00
#define ADS869xExt_DATAOUT_CTL_REG_RANGE_INCL              0x00000100
#define ADS869xExt_DATAOUT_CTL_REG_PAR_EN                  0x00000008
#define ADS869xExt_DATAOUT_CTL_REG_DATA_VAL                0x00000007

#define ADS869xExt_RST_PWRCTL_REG_WKEY                     0x0000FF00
#define ADS869xExt_RST_PWRCTL_REG_VDD_AL_DIS               0x00000020
#define ADS869xExt_RST_PWRCTL_REG_IN_AL_DIS                0x00000010
#define ADS869xExt_RST_PWRCTL_REG_RSTN_APP                 0x00000004
#define ADS869xExt_RST_PWRCTL_REG_NAP_EN                   0x00000002
#define ADS869xExt_RST_PWRCTL_REG_PWRDN                    0x00000001

#define ADS869xExt_RANGE_SEL_REG_INTREF_DIS                0x00000040
#define ADS869xExt_RANGE_SEL_REG_RANGE_SEL                 0x0000000F

#define ADS869xExt_ALARM_REG_ACTIVE_VDD_L_FLAG             0x00008000
#define ADS869xExt_ALARM_REG_ACTIVE_VDD_H_FLAG             0x00004000
#define ADS869xExt_ALARM_REG_ACTIVE_IN_L_FLAG              0x00000800
#define ADS869xExt_ALARM_REG_ACTIVE_IN_H_FLAG              0x00000400
#define ADS869xExt_ALARM_REG_TRP_VDD_L_FLAG                0x00000080
#define ADS869xExt_ALARM_REG_TRP_VDD_H_FLAG                0x00000040
#define ADS869xExt_ALARM_REG_TRP_IN_L_FLAG                 0x00000020
#define ADS869xExt_ALARM_REG_TRP_IN_H_FLAG                 0x00000010
#define ADS869xExt_ALARM_REG_OVW_ALARM                     0x00000001


constexpr static double ADS869xExtInternalReferenceVoltage = 4.096;

class ADS869xExt{
    public:
        /**
         * @brief Construct a new ADS869xExt object
         * @details Used static define SPI.
         * 
         * @param spiPrescaler divider SPI clock.
         * @param numberOfCalibrationPoints default 256 points.
         */
        ADS869xExt(unsigned long spiPrescaler, unsigned long numberOfCalibrationPoints);
        
        /**
         * @brief Destroy the ADS869xExt object
         * 
         */
        ~ADS869xExt();
        ...
        double calcDeformation(uint32_t code);
        double calcDeformation2(uint32_t code);
        double calcDeformation3(uint32_t code);
         ...
         */
        void setDataOut(bool deviceAddr, ADS869xExtActiveAlarm vddActiveAlarm, ADS869xExtActiveAlarm inActiveAlarm, bool range, bool parity, ADS869xExtDataVal dataVal);
         ...
         */
        void setRange(ADS869xExtExternalRef externalRef, ADS869xExtRange range);
         ...
         */
        void setADCSPIMode(ADS869xExtSPIMode spiMode);
         ...
         */
        void setADCSDOMode(ADS869xExtSDO1Config SDO1Config, ADS869xExtSSyncClk SSyncClk, ADS869xExtSDOMode SDOMode);
    ...
    private:
        ...
        CircularBuffer<ADS869xExtSendDataPacket_t, 10> sendQueue;
        ...
        /*  Vref voltage    */
        double Vref = ADS869xExtInternalReferenceVoltage;
        ADS869xExtRange range = ADS869xExt_PM_3;
        ADS869xExtExternalRef externalReference = ADS869xExt_EXTERNAL_REF_DISABLED;
        double LSBWeight = 0;
        double PFS, NFS;
        #if BOARD_INDEX == 2
        ...
        #endif
        ADS869xExtSendDataPacket_t lastPacket;
        ADS869xExtSendDataPacket_t lastPacket2;
        ADS869xExtSendDataPacket_t lastPacket3;
        ADS869xExtOutputDataWord_t outputWord;
        ADS869xExtRegisters_t registers = {0};
        ADS869xExtCmd lastCmd = ADS869xExt_CMD_NOP;
         ...
         */
        void prepareSendBits(ADS869xExtSendDataPacket_t *packet);
         ...
         * @param packet data struct
         */
        void parseReceiveBits(ADS869xExtSendDataPacket_t *packet);
};
