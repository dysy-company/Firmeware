...
#ifndef Pin_Config_h743_like_h
#define Pin_Config_h743_like_h
/*
    PORT A
*/
...
*/      
    ...
    PinName DO_RSSI_DisplSensor_SCK                 = PF_7;//SPI5
    PinName DI_RSSI_DisplSensor_DATA                = PF_8;//SPI5
#endif
...
*/
    ...
    PinName DO_RC_11                                = PE_3;     //to additional board J3 socket
        ...
        //hardware output analog cmds      
        PinName DO_RC_0                                 = PD_14;     //COMMAND1
        PinName DO_RC_1                                 = PD_15;     //COMMAND2
        PinName DO_RC_2_MOTOR_STEP_CW                   = PD_10;     //COMMAND3
        PinName DO_RC_3_MOTOR_DIR_CCW                   = PG_8;    //COMMAND4
        PinName DO_RC_4_WARNING_LIGHT                   = PG_5;     //COMMAND5
        PinName DO_RC_5_MOTOR_ENABLE                    = PG_6;    //COMMAND6
        PinName DO_RC_6_ALARM_LIGHT                     = PG_9;      //COMMAND7
        PinName DO_RC_7                                 = PG_12;     //COMMAND8
    #endif
...
*/
    ...
    #if (CONTROLLER_BOARD_TYPE == CONTROLLER_BOARD_TYPE_SERVO_HYDRAULIC_GREEN)
        //Direction pins
        PinName DO_Direct_H                             = PC_8;
        //PinName DO_Direct_L = PC_7;
        PinName DO_Reverse_H                            = PC_9;
        //PinName DO_Reverse_L = PA_13
    #endif
	...
	// Remote Controller
	PinName DO_UART2_TX_REMOTECONTROLLER = PD_5;
	PinName DI_UART2_RX_REMOTECONTROLLER = PD_6;
/*
    PORT G
*/
    ...
    #if (CONTROLLER_BOARD_TYPE == CONTROLLER_BOARD_TYPE_SERVO_HYDRAULIC_RED)
    PinName DI_FB_RC_0                              = PG_0;
    PinName DI_FB_RC_1                              = PG_1;
    PinName DI_FB_RC_2                              = PG_2;
    #endif
    #endif
...
*/
        ...
        #if (PROJECT_NAME == PROJECT_NAME_OLD_SVM_BOARD)
        PinName IP_MK6  = PE_11;
        #else
        PinName IP_MK6  = PG_5; //PG_5 v2.1
        #endif
        ...
        PinName IP_MK1  = PF_1;
        PinName IP_MK2  = PF_0;
        PinName IP_MK3  = PE_13;
        PinName IP_MK4  = PE_11;
        PinName IP_MK5  = PE_12;
        PinName IP_MK6  = PG_15;
        PinName IP_MK7  = PE_10;
        PinName IP_MK8  = PG_14;
        PinName IP_MK9  = PG_2;
        PinName IP_MK10 = PG_3;
    #endif
